...
Episode.create([
  { title: '11 weeks from now', season: 11, episode_number: '01', show_id: shows[3].id, airdate: 11.weeks.from_now.to_date },
  { title: '12 weeks from now', season: 11, episode_number: '02', show_id: shows[3].id, airdate: 12.weeks.from_now.to_date },
  { title: '13 weeks from now', season: 11, episode_number: '03', show_id: shows[3].id, airdate: 13.weeks.from_now.to_date },
  { title: '14 weeks from now', season: 11, episode_number: '04', show_id: shows[3].id, airdate: 14.weeks.from_now.to_date }
])

# Episodes for Off Air Show 1
Episode.create([
  { title: '14 weeks ago', season: 1, episode_number: '01', show_id: shows[4].id, airdate: 14.weeks.ago.to_date },
  { title: '13 weeks ago', season: 1, episode_number: '02', show_id: shows[4].id, airdate: 13.weeks.ago.to_date },
  { title: '12 weeks ago', season: 1, episode_number: '03', show_id: shows[4].id, airdate: 12.weeks.ago.to_date },
  { title: '11 weeks ago', season: 1, episode_number: '04', show_id: shows[4].id, airdate: 11.weeks.ago.to_date }
])

# Episodes for Off Air Show 2
Episode.create([
  { title: '23 weeks ago', season: 1, episode_number: '01', show_id: shows[5].id, airdate: 23.weeks.ago.to_date },
  { title: '22 weeks ago', season: 1, episode_number: '02', show_id: shows[5].id, airdate: 22.weeks.ago.to_date },
  { title: '21 weeks ago', season: 1, episode_number: '03', show_id: shows[5].id, airdate: 21.weeks.ago.to_date },
  { title: '20 weeks ago', season: 1, episode_number: '04', show_id: shows[5].id, airdate: 20.weeks.ago.to_date },
  { title: '14 weeks ago', season: 2, episode_number: '01', show_id: shows[5].id, airdate: 14.weeks.ago.to_date },
  { title: '13 weeks ago', season: 2, episode_number: '02', show_id: shows[5].id, airdate: 13.weeks.ago.to_date },
  { title: '12 weeks ago', season: 2, episode_number: '03', show_id: shows[5].id, airdate: 12.weeks.ago.to_date },
  { title: '11 weeks ago', season: 2, episode_number: '04', show_id: shows[5].id, airdate: 11.weeks.ago.to_date }
  ])
