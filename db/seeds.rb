...
Episode.create([
  ...
  { title: Faker::Name.name, season: 3, episode_number: '04', show_id: shows[0].id, airdate: 2.days.ago.to_date },
  { title: Faker::Name.name, season: 3, episode_number: '05', show_id: shows[0].id, airdate: 5.days.from_now.to_date },
  { title: Faker::Name.name, season: 3, episode_number: '06', show_id: shows[0].id, airdate: 1.week.from_now },
...
Episode.create([
  ...
  { title: Faker::Name.name, season: 1, episode_number: '04', show_id: shows[1].id, airdate: 3.days.ago.to_date },
